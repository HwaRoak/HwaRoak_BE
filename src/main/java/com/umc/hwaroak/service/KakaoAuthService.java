...
import org.springframework.data.redis.core.RedisTemplate; // JWT를 redis에 저장
...
public class KakaoAuthService {
    ...
    public KakaoLoginResponseDto kakaoLogin(String kakaoAccessToken) {
        ...
        // Redis 저장 (key: RT:userId, value: refreshToken)
        redisTemplate.opsForValue().set("RT:" + member.getId(), refreshToken, refreshTokenValidity, TimeUnit.MILLISECONDS);
